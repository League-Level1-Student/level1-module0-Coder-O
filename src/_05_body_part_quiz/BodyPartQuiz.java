...
public class BodyPartQuiz {
	...
	private void startQuiz() {
		...
		String[] people = {"Arnold", "Leonardo", "Morgan", "Jack"};
		...
		for (int i = 0; i < people.length; i++) {
			...
			if(guess.equalsIgnoreCase(people[i])) {
			...
			// -- Tell them they are wrong and who the person is
				...
				JOptionPane.showMessageDialog(null, "Incorrect! This is "+people[i]+".");
			}
		...
		JOptionPane.showMessageDialog(null, "Your final score was: "+score+"/"+people.length);
	}
