...
public class DrumKit implements MouseListener {
	...
	public void run() throws MalformedURLException {
		...
		frame.setTitle("Tittlllllleeeeeee");
		...
		// Eclipse project under "_04_drum_kit".

		// 8. Put the name of your image file in a String variable.
		String imageName = "LeaugeDrum.jpeg";
		// 9. Edit the next line to use your String variable
		drumLabelWithImage = createLabelImage(imageName);
		cymbalLabelImage = createLabelImage("cymbal.jpg");

		// 10. Add the image to the panel
		panel.add(drumLabelWithImage);
		panel.add(cymbalLabelImage);
		...
		cymbalLabelImage.addMouseListener(this);
	...
	public void mouseClicked(MouseEvent e) {
		...
		// it works
				playSound("drum.wav");
		} else if(drumClicked.equals(cymbalLabelImage)) {
